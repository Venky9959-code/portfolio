...
const journey: RouteStop[] = [
  {
    ...
    description: 'Pursuing Computer Science Engineering with a strong focus on Software Development, Web Technologies, ASP.NET MVC, and Artificial Intelligence.',
  },
  {
    id: '02',
    year: '2025 - PRESENT',
    title: 'FOUNDER & LEAD DEVELOPER',
    organization: 'SKILLSBOOSTHUB',
    description: 'Building a student-focused platform dedicated to career development, mentorship, future-ready skills, and technical learning.',
  },
  {
    id: '03',
    year: '2025',
    title: 'TECHXELERATE HACKATHON',
    organization: 'BITS PILANI HYDERABAD',
    description: 'Participated in high-impact innovation-based hackathon and startup ecosystem activities.',
  },
  {
    id: '04',
    year: '2024',
    title: 'T-HUB / TIHAN PROGRAM',
    organization: 'IIT HYDERABAD',
    description: 'Engaged with emerging technologies, innovation projects, autonomous system concepts, and AI development.',
  },
];
