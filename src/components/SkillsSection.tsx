...
const bentoCategories = [
  {
    ...
    description: 'Designing clean, modern, and responsive user interfaces with smooth CSS animations and component architecture.',
    stat: '100% RESPONSIVE',
  ...
  },
  {
    ...
    badge: 'CORE SYSTEMS',
    items: ['ASP.NET MVC', 'C#', 'Full Stack Development', 'Node.js', 'REST APIs'],
    description: 'Building secure web applications, server-side controller architectures, and robust API endpoints.',
  ...
  },
  {
    ...
    badge: 'PERSISTENCE',
    items: ['SQL Server', 'Firebase', 'MySQL'],
    description: 'Architecting relational SQL Server databases, real-time Firebase backend services, and structured queries.',
    stat: 'ACID & REALTIME',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    badge: 'AI & DATA',
    items: ['Machine Learning', 'Python', 'scikit-learn', 'Algorithm Design'],
    description: 'Developing predictive models, data forecasting engines, and AI-driven solutions for real-world problems.',
    stat: 'PREDICTIVE AI',
    colSpan: 'lg:col-span-7',
  },
];
